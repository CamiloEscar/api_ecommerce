...
// RUTAS DE HISTORIAL DE VENTAS (NUEVAS - FUERA DEL GRUPO DE STOCK)
    ...
    Route::post('sales/{sale_id}/shipping-status',[ProductSalesHistoryController::class, 'updateShippingStatus']
);
...
Route::group([
    ...
    Route::group([
        ...
        Route::get('carts/validate-stock', [CartController::class, 'validate_stock']);
        ...
        Route::post('mercadopago', [SaleController::class, "mercadopago"]);
