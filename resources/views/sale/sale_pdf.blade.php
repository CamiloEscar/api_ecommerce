        ...
        <tbody>
            <tr>
                <td style="padding: 0 !important;border-bottom:none;">
                    <img
                        style="width: 150px; height: 100px;background:black;"
                        src="{{public_path('logo.jpeg')}}"
                    >
                </td>
                <td style="padding: 0 !important;border-bottom:none;">
                    <br>
                    <small>Tel. 3442 475466</small>
                    <br>
                    <small>Uader FCyT <br> C.P. 3260 <br> Concepción del Uruguay, Entre Ríos, Argentina </small>
  ...
  <table class="invoice-info-container">
    ...
    <tr>
        <td>
            ...
            <br>
            REGION/CIUDAD: <strong>{{ $sale->sale_addres->country_region }} /
